...
| R-003 | Tool schemas leak to weak local models. | V5-003, V5-010, V5-012, V5-016 | Critical | Gate tool definitions immediately before provider calls. Add fake provider tests that assert zero schemas. | Partially mitigated by V5-003 provider-call suppression and V5-010 mission route switching; authority-tier enforcement and E2E remain open. |
