...
| R-012 | Authority-tier enforcement lacks enough tool risk metadata for precise medium/high distinctions. | V5-011, V5-012 | High | Run taxonomy discovery before enforcement. Stop if metadata is insufficient instead of inventing broad semantics. | Partially mitigated by V5-011 conservative built-in classifier; dynamic MCP tools remain unclassified and must fail closed or stay out of authority-tier widening in V5-012. |
