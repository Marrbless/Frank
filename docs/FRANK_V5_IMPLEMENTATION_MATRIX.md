...
| R-005 | Legacy config or raw `-M` override breaks. | V5-002, V5-004, V5-016, V5-017 | High | Keep implicit legacy profile and raw model compatibility tests in every runtime slice touching startup. | Mitigated in code by V5-016 legacy fixture coverage; final migration docs remain open. |
| R-006 | CLI model override ambiguity between alias, model ref, and raw provider model changes behavior. | V5-002, V5-010, V5-016 | Medium | Preserve V5-001 rule: model ref wins, alias resolves deterministically, unknown value becomes raw legacy provider model only on legacy-compatible path. Document this clearly. | Mitigated in tests by alias, model-ref, raw legacy, and policy-denial paths; final migration docs remain open. |
