...
func formatOperatorStatusReadoutWithDeferredSchedulerTriggers(summary string, missionStoreRoot string) (string, error) {
	...
	statusSummary = missioncontrol.WithImprovementCandidateIdentity(statusSummary, missionStoreRoot)
	statusSummary = missioncontrol.WithEvalSuiteIdentity(statusSummary, missionStoreRoot)
	statusSummary = missioncontrol.WithPromotionPolicyIdentity(statusSummary, missionStoreRoot)
	...
	statusSummary = missioncontrol.WithHotUpdateCanaryRequirementIdentity(statusSummary, missionStoreRoot)
	statusSummary = missioncontrol.WithHotUpdateCanaryEvidenceIdentity(statusSummary, missionStoreRoot)
	...
	statusSummary = missioncontrol.WithCandidatePromotionDecisionIdentity(statusSummary, missionStoreRoot)
	...
	statusSummary = missioncontrol.WithRollbackIdentity(statusSummary, missionStoreRoot)
	statusSummary = missioncontrol.WithRollbackApplyIdentity(statusSummary, missionStoreRoot)
	statusSummary = missioncontrol.WithV4Summary(statusSummary)
